      ...
      <section id="contact-me" className="contact-me px-5">
         ...
         <div className="container contacts_container d-flex flex-column">
            <div className="contact-me_container_cards w-xl-50 d-flex flex-column md-flex-row flex-grow-1 gap-3 mx-auto">
               <SmallCard icon={MdOutlineEmail} title={t("Email")} subtitle={t("c.plaitano@gmail.com")} />
               <SmallCard icon={RiMessengerLine} title={t("Messenger")} subtitle={t("m.me/carmine.plaitano.3")} />
               <SmallCard icon={BsWhatsapp} title={t("WhatsApp")} subtitle={t("+39 327 2061 751")} />
            </div>
